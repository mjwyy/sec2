...
public class ReceivingNoteInputDataService_Driver {
    ...
    public void drive(ReceivingNoteInputDataService service) throws RemoteException, SQLException, ElementNotFoundException, InterruptWithExistedElementException {
