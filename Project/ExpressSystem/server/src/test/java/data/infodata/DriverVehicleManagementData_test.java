...
public class DriverVehicleManagementData_test {
	...
	public void testFindDriver() throws RemoteException, ElementNotFoundException {
		assertEquals(driver1,service.inquireDriver(new MockDriver("025010007", null, null,null, null, null,
				null)));
		assertEquals(driver2,service.inquireDriver(new MockDriver(null, "王莉", null,null, null, null,
				null)));
	...
	public void testFindVehicle() throws RemoteException {
		assertEquals(vehicle1,service.inquireVehicle(new MockVehicle("02501000001",null,null,
				null)));
		assertEquals(vehicle2,service.inquireVehicle(new MockVehicle("02501000002",null,null,
				null)));	
	}
