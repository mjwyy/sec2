...
public interface BaseDataBuildingBLService {
	...
	/**
	 * 有基�?期初建账，输入修改后的或者未修改的的机构，库存，财务信息
	 * 前置条件：财务人员要求进行以上年为基�?的建账操�?
	 * 后置条件：系统提示期初建账成功，更新相应信息，生成待查副本，记录日志
	 * 
	 * @param institutionVO
	 * @param commodityInfoVO
	...
	/**
	 * 前置条件：财务人员开始以上年为基�?的期初建账操�?
	 * 后置条件：系统存储新的机构信息，并反馈机构信息保存成�?
	 * 
	 * @param institutionVO
	 * @return
	 */
