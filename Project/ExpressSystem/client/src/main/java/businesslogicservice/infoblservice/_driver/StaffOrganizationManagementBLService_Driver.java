...
public class StaffOrganizationManagementBLService_Driver {
	...
	public void drive(StaffOrganizationManagementBLService service){
		service.addStaff(new StaffVO("Tommy", null, null, null, 2, null,null));
		service.delStaff(new StaffVO("Tommy", null, null, null, 2, null, null));
		service.findStaffInfo(new StaffVO("Tommy", null, null, null, 2, null, null));
		service.ModifyStaff(new StaffVO("Tommy", null, null, null, 2, null, null));
