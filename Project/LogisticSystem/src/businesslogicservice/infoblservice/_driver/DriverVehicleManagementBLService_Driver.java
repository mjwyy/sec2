...
public class DriverVehicleManagementBLService_Driver{
	...
	public void drive(DriverVehicleManagementBLService service){
		service.addDriver(new DriverInfoVO("00210", "����", "2001-10-04", null, null, null, null));
		service.deleteDriver(new DriverInfoVO("00210", "����", "2001-10-04", null, null, null, null));
		service.findDriver(new DriverInfoVO("00210", "����", "2001-10-04", null, null, null, null));
		service.modifyDriver(new DriverInfoVO("00210", "����", "2001-10-04", null, null, null, null));
