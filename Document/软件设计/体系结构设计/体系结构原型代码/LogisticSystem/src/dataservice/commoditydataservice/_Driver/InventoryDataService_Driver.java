...
public class InventoryDataService_Driver {
    ...
    public void drive(InventoryDataService inventoryDataService) throws RemoteException {
    	ArrayList<InventoryPO> pos = inventoryDataService.findAll();
    	System.out.println("find "+pos.size()+" InventoryPO");
    	ArrayList<InventoryPO> pos1 = inventoryDataService.findByTime("2015-10-01","2015-10-11");
    	System.out.println("find "+pos1.size()+" InventoryPO");
    	ArrayList<InventoryPO> pos2 = inventoryDataService.findByTime("2015-10-12","2015-11-26");
    	System.out.println("find "+pos2.size()+" InventoryPO");
    	ArrayList<InventoryPO> pos3 = inventoryDataService.findByTime("2015-11-01","2015-12-11");
