...
public class Deliver_Note_On_Service extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					changeLook();
					changeFont();
					Deliver_Note_On_Service frame = new Deliver_Note_On_Service();
	 ...
	 * Create the frame.
	 */
	public Deliver_Note_On_Service() {
		setResizable(false);
	...
	public void init(){
		...
		JLabel label_15 = new JLabel("派件单");
